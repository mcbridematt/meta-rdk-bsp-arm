...
SYSTEMD_SERVICE_${PN}:append = " dropbear.service btrfs-subvolume.service"
SYSTEMD_SERVICE_${PN}:remove:broadband = "dropbear.service"
SYSTEMD_SERVICE_${PN}:remove:broadband = "ntp-data-collector.service"
SYSTEMD_SERVICE_${PN}:append:bootbroadband += " boot-time-upload.service monitor-upload.service"
